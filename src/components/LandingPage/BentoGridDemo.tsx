...
const items = [
  {
    title: "Save Time",
    description: "Quickly find and reuse the code snippets you need, reducing development time and increasing productivity.",
    header: <SkeletonTwo/>,
    icon: <IconClipboardCopy className="h-4 w-4 text-neutral-500" />,
  },
  {
    title: "Stay Organized",
    description: "Keep your code snippets neatly organized and easily accessible, so you can focus on writing great code.",
    header: <SkeletonOne/>,
  ...
  },
  {
    ...
    description:
      "Empowers users with personalized workspaces and repositories tailored to their individual preferences and workflow.",
    header: <SkeletonThree />,
    icon: <IconTableColumn className="h-4 w-4 text-neutral-500" />,
  },
  {
    title: "Effortless Collaboration",
    description: "Share and collaborate on code snippets with your team, ensuring everyone has access to the resources they need.",
    header: <Skeleton />,
